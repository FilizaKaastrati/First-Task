...
const DomainData = [
  {
    id: "q1",
    title: "The TLD",
    icon: <ExtensionOutlinedIcon color="primary" fontSize="medium" />,
    description:
  ...
  },
  {
    id: "q2",
    title: "Domain Length",
    icon: <StraightenOutlinedIcon color="primary" fontSize="medium" />,
